...
"""
@kwdef struct RotatingFrame
    ω
    x0
    x1
end

struct Physics{T,F,SO,M,Tu,E,D,BI,MRF}
    time::T
    fluid::F
    solid::SO
    momentum::M
...
"""
Physics(; time, fluid=nothing, solid=nothing, turbulence=nothing, energy, domain, mrf=nothing) = begin
